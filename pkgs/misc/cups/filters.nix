...
# 
#   src = fetchurl {
#     url = "http://openprinting.org/download/cups-filters/cups-filters-${version}.tar.xz";
...
# 
#     ghostscript poppler 
#     freetype lcms2 zlib bc libtiff avahi
# 
...
, libjpeg, libpng, perl, ijs, qpdf, dbus , freetype, lcms2, zlib, bc, libtiff, avahi
, ghostscript # ghostscript version can be overridden in the cups module easily
}:
