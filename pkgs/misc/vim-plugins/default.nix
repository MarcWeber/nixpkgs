...
rec {
  ...
  "Colour_Sampler_Pack" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "Gist" = buildVimPlugin { # created by nix#NixDerivation
    name = "Gist";
    src = fetchgit {
  ...
  "Gundo" = buildVimPlugin { # created by nix#NixDerivation
    name = "Gundo";
    src = fetchhg {
  ...
  "Hoogle" = buildVimPlugin { # created by nix#NixDerivation
    name = "Hoogle";
    src = fetchgit {
  ...
  "Solarized" = buildVimPlugin { # created by nix#NixDerivation
    name = "Solarized";
    src = fetchgit {
  ...
  "Supertab" = buildVimPlugin { # created by nix#NixDerivation
    name = "Supertab";
    src = fetchgit {
  ...
  "Syntastic" = buildVimPlugin { # created by nix#NixDerivation
    name = "Syntastic";
    src = fetchgit {
  ...
  "Tabular" = buildVimPlugin { # created by nix#NixDerivation
    name = "Tabular";
    src = fetchgit {
  ...
  "Tagbar" = buildVimPlugin { # created by nix#NixDerivation
    name = "Tagbar";
    src = fetchgit {
  ...
  "The_NERD_Commenter" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "The_NERD_tree" = buildVimPlugin { # created by nix#NixDerivation
    name = "The_NERD_tree";
    src = fetchgit {
  ...
  "UltiSnips" = buildVimPlugin { # created by nix#NixDerivation
    name = "UltiSnips";
    src = fetchgit {
  ...
  "VimOutliner" = buildVimPlugin { # created by nix#NixDerivation
    name = "VimOutliner";
    src = fetchgit {
  ...
  "YankRing" = buildVimPlugin { # created by nix#NixDerivation
    name = "YankRing";
    src = fetchurl {
  ...
  "commentary" = buildVimPlugin { # created by nix#NixDerivation
    name = "commentary";
    src = fetchgit {
  ...
  "ctrlp" = buildVimPlugin { # created by nix#NixDerivation
    name = "ctrlp";
    src = fetchgit {
  ...
  "extradite" = buildVimPlugin { # created by nix#NixDerivation
    name = "extradite";
    src = fetchgit {
  ...
  "fugitive" = buildVimPlugin { # created by nix#NixDerivation
    name = "fugitive";
    src = fetchgit {
  ...
  "ghcmod" = buildVimPlugin { # created by nix#NixDerivation
    name = "ghcmod";
    src = fetchgit {
  ...
  "github_MarcWeber" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "pathogen" = buildVimPlugin { # created by nix#NixDerivation
    name = "pathogen";
    src = fetchgit {
  ...
  "quickfixstatus" = buildVimPlugin { # created by nix#NixDerivation
    name = "quickfixstatus";
    src = fetchgit {
  ...
  "rainbow_parentheses" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "surround" = buildVimPlugin { # created by nix#NixDerivation
    name = "surround";
    src = fetchgit {
  ...
  "table-mode" = buildVimPlugin { # created by nix#NixDerivation
    name = "table-mode";
    src = fetchgit {
  ...
  "undotree" = buildVimPlugin { # created by nix#NixDerivation
    name = "undotree";
    src = fetchgit {
  ...
  "vim-addon-manager" = buildVimPlugin { # created by nix#NixDerivation
    ...
    src = fetchgit {
      ...
      rev = "96d410246188210e3494ead10f06d104457effad";
      sha256 = "e1135f1d0e81e9948bf83a177bc0dae634fdb95fd711f3a932fd1bc1884c8fae";
    };
    dependencies = [];
  };
  ...
  "vim-airline" = buildVimPlugin { # created by nix#NixDerivation
    name = "vim-airline";
    src = fetchgit {
  ...
  "vim-easy-align" = buildVimPlugin { # created by nix#NixDerivation
    name = "vim-easy-align";
    src = fetchgit {
  ...
  "vim-gitgutter" = buildVimPlugin { # created by nix#NixDerivation
    name = "vim-gitgutter";
    src = fetchgit {
  ...
  "vim-latex-live-preview" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "vim-signature" = buildVimPlugin { # created by nix#NixDerivation
    name = "vim-signature";
    src = fetchgit {
  ...
  "vim2hs" = buildVimPlugin { # created by nix#NixDerivation
    name = "vim2hs";
    src = fetchgit {
  ...
  "vundle" = buildVimPlugin { # created by nix#NixDerivation
    name = "vundle";
    src = fetchgit {
  ...
  "wombat256" = buildVimPlugin { # created by nix#NixDerivation
    name = "wombat256";
    src = fetchurl {
