...
rec {
  ...
  "vim-addon-haskell" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "vim-addon-signs" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "vim-addon-mw-utils" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "vim-addon-sql" = buildVimPlugin { # created by nix#NixDerivation
    name = "vim-addon-sql";
    src = fetchgit {
  ...
  "vim-addon-background-cmd" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "github:MarcWeber" = buildVimPlugin { # created by nix#NixDerivation
    name = "github_MarcWeber";
    src = fetchgit {
  ...
  "vim-addon-toc" = buildVimPlugin { # created by nix#NixDerivation
    name = "vim-addon-toc";
    src = fetchgit {
  ...
  "vim-addon-goto-thing-at-cursor" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "vim-addon-actions" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "vim-addon-completion" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "vim-addon-xdebug" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "WebAPI" = buildVimPlugin { # created by nix#NixDerivation
    name = "WebAPI";
    src = fetchgit {
  ...
  "vim-addon-surround" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "sourcemap.vim" = buildVimPlugin { # created by nix#NixDerivation
    name = "sourcemap.vim";
    src = fetchgit {
  ...
  "vim-addon-other" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "vim-addon-json-encoding" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "textobj-user" = buildVimPlugin { # created by nix#NixDerivation
    name = "textobj-user";
    src = fetchgit {
  ...
  "reload" = buildVimPlugin { # created by nix#NixDerivation
    name = "reload";
    src = fetchgit {
  ...
  "vim-addon-async" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "snipmate" = buildVimPlugin { # created by nix#NixDerivation
    name = "snipmate";
    src = fetchgit {
  ...
  "vim-addon-mru" = buildVimPlugin { # created by nix#NixDerivation
    name = "vim-addon-mru";
    src = fetchgit {
  ...
  "vim-addon-ruby-debug-ide" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "tlib" = buildVimPlugin { # created by nix#NixDerivation
    name = "tlib";
    src = fetchgit {
  ...
  "sparkup" = buildVimPlugin { # created by nix#NixDerivation
    name = "sparkup";
    src = fetchgit {
  ...
  "vim-addon-manager" = buildVimPlugin { # created by nix#NixDerivation
    name = "vim-addon-manager";
    src = fetchgit {
      url = "git://github.com/MarcWeber/vim-addon-manager";
      rev = "3b40f4332d71491c979671d030557ef418e679b3";
      sha256 = "27b7b6455e37fadb773a7be1112fa99c561a39d60de988056441a87cf02ff730";
    };
    dependencies = [];
  };
  "matchit.zip" = buildVimPlugin { # created by nix#NixDerivation
    name = "matchit.zip";
    src = fetchurl {
  ...
  "vim-addon-errorformats" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "vim-addon-php-manual" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "vim-dev-plugin" = buildVimPlugin { # created by nix#NixDerivation
    name = "vim-dev-plugin";
    src = fetchgit {
  ...
  "phpcomplete" = buildVimPlugin { # created by nix#NixDerivation
    name = "phpcomplete";
    src = fetchgit {
  ...
  "vim-addon-views" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "vim-addon-rdebug" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "vim-addon-nix" = buildVimPlugin { # created by nix#NixDerivation
    name = "vim-addon-nix";
    src = fetchgit {
  ...
  "vim-addon-syntax-checker" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "openscad" = buildVimPlugin { # created by nix#NixDerivation
    name = "openscad";
    src = fetchgit {
  ...
  "vim-addon-git" = buildVimPlugin { # created by nix#NixDerivation
    name = "vim-addon-git";
    src = fetchgit {
  ...
  "vim-iced-coffee-script" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "vim-coffee-script" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "vim-addon-rfc" = buildVimPlugin { # created by nix#NixDerivation
    name = "vim-addon-rfc";
    src = fetchgit {
  ...
  "vim-addon-commenting" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "rust" = buildVimPlugin { # created by nix#NixDerivation
    name = "rust";
    src = fetchgit {
  ...
  "vim-snippets" = buildVimPlugin { # created by nix#NixDerivation
    name = "vim-snippets";
    src = fetchgit {
  ...
  "vim-addon-toggle-buffer" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "textobj-rubyblock" = buildVimPlugin { # created by nix#NixDerivation
  ...
  "vim-ruby" = buildVimPlugin { # created by nix#NixDerivation
    name = "vim-ruby";
    src = fetchgit {
  ...
  "vim-addon-local-vimrc" = buildVimPlugin { # created by nix#NixDerivation
